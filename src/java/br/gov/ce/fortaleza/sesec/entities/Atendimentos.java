...
@NamedQueries({
    ...
    @NamedQuery(name = "Atendimentos.findByCurrentDate", query = "SELECT a FROM Atendimentos a WHERE a.dataSolicitacao = CURRENT_DATE"),
    @NamedQuery(name = "Atendimentos.findByCurrentMonth", query = "SELECT a FROM Atendimentos a WHERE FUNC('MONTH', a.dataSolicitacao) = FUNC('MONTH', CURRENT_DATE)"),
//    @NamedQuery(name = "Atendimentos.findByQtdOcrCurrentMonth", query = "SELECT a, COUNT(*) AS qtdOcorrencia FROM Atendimentos a WHERE FUNC('MONTH', a.dataSolicitacao) = FUNC('MONTH', CURRENT_DATE) GROUP BY a.dataSolicitacao"),
