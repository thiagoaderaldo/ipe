 ...
 * @author adminiscti
 */
public class PlainRolePrincipal implements Principal, java.io.Serializable {
	...
	if (o == null)
        ...
        if (!(o instanceof PlainRolePrincipal))
            return false;
        PlainRolePrincipal that = (PlainRolePrincipal)o;
