 ...
 * @author adminiscti
 */
public class PlainUserPrincipal implements Principal, java.io.Serializable {
	...
	if (o == null)
        ...
        if (!(o instanceof PlainUserPrincipal))
            return false;
        PlainUserPrincipal that = (PlainUserPrincipal)o;
